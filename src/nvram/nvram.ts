...
export const bt_binary_custom: NvramProperty<string> = {
  ...
  page: "nas-bittorrent.asp.html",
  type: "string",
***REMOVED*** "/path/to/binaries/directory",
  ui: {
    state: {
      dependsOn: ["bt_binary"],
      evaluator: (values) =>
...
export const bt_blocklist_url: NvramProperty<string> = {
  ...
  page: "nas-bittorrent.asp.html",
  type: "string",
***REMOVED*** "http://list.iblocklist.com/?list=bt_level1",
  ui: {
    state: {
...
export const cifs: PatternedNvramProperty<{ index: 1 | 2 }, CifsConfig> = {
  ...
  type: "structured-string",
***REMOVED*** { enabled: false, unc: "", username: "" },
  transform: {
    toUi: (value) => {
...
export const cstats_stime: NvramProperty<number> = {
  ...
  page: "admin-iptraffic.asp.html",
  type: "enum",
***REMOVED*** 24, // Assuming a common default, was empty in source
  ui: {
...
export const ct_tcp_timeout: NvramProperty<number[]> = {
  ...
  page: "advanced-ctnf.asp.html",
  type: "structured-string",
***REMOVED*** [0, 1200, 120, 60, 120, 120, 10, 60, 30, 0],
  transform: {
...
export const ftp_limit: NvramProperty<FtpLimit> = {
  ...
  page: "nas-ftp.asp.html",
  type: "structured-string",
***REMOVED*** { enabled: false, hits: 3, seconds: 60 },
  transform: {
    toUi: (value) => {
      const parts = value.split(",");
      return {
...
export const ipv6_dns: NvramProperty<string> = {
  ...
  page: "basic-ipv6.asp.html",
  type: "string",
***REMOVED*** "2606:4700:4700::1111 2606:4700:4700::1001",
  ui: {
    label: "Static DNS",
  },
};
...
export const NC_GatewayName: NvramProperty<string> = {
  ...
  page: "splashd.asp.html",
  type: "string",
***REMOVED*** "FreshTomato Captive Portal",
  validation: (value) =>
...
export const ne_shlimit: NvramProperty<Shlimit> = {
  ...
  page: "admin-access.asp.html",
  type: "structured-string",
***REMOVED*** { mode: 1, hits: 3, seconds: 60 },
  transform: {
    toUi: (value) => {
...
export const qos_irates: NvramProperty<string> = {
  ...
  page: "qos-settings.asp.html",
  type: "string",
***REMOVED*** "5-100,2-20,5-100,10-90,20-90,5-90,5-70,5-100,5-30,1-1",
  ui: {
...
export const qos_orates: NvramProperty<string> = {
  ...
  page: "qos-settings.asp.html",
  type: "string",
***REMOVED*** "5-100,5-30,5-100,5-70,5-70,5-70,5-70,5-100,5-30,1-1",
  ui: {
...
const scheduleProperty = (
  ...
  page,
  type: "structured-string",
***REMOVED*** { enabled: false, time: 0, days: 0 },
...
export const sesx_script: NvramProperty<string> = {
  ...
  page: "admin-buttons.asp.html",
  type: "string",
***REMOVED*** "[ $1 -ge 20 ] && telnetd -p 233 -l /bin/sh\x0a",
  ui: {
    label: "Custom Script",
  },
};
...
export const tm_sel: NvramProperty<string> = {
  ...
  page: "basic-time.asp.html",
  type: "enum",
***REMOVED*** "PST8PDT,M3.2.0/2,M11.1.0/2",
  ui: {
    label: "UTC offsets",
  },
};
...
export const ttb_url: NvramProperty<string> = {
  ...
  page: "admin-access.asp.html",
  type: "string",
***REMOVED*** "http://ttb.mooo.com http://ttb.ath.cx http://ttb.ddnsfree.com",
  ui: {
    label: "TTB URL",
    state: {
      dependsOn: ["web_css"],
...
const upnpLanProperty = (lanIndex: 0 | 1 | 2 | 3): NvramProperty<boolean> => ({
  ...
  page: "forward-upnp.asp.html",
  type: "boolean",
***REMOVED*** lanIndex === 0 ? false : undefined, // Assuming default is likely for br0 only if any
  transform: booleanTransformer,
  ui: {
    label: `LAN${lanIndex}`,
  },
...
export const upnp_secure: NvramProperty<boolean> = {
  ...
  page: "forward-upnp.asp.html",
  type: "boolean",
***REMOVED*** true, // secure by default
  transform: {
    toUi: (v) => v === "1",
    fromUi: (v) => (v ? "1" : "0"),
  },
...
export const vpn_server_local = vpnServerPatternedProperty<string>("local", {
  ...
  page: "vpn-server.asp.html",
  type: "ip",
***REMOVED*** "10.6.0.1", // Default for server 1
...
export const vpn_server_port = vpnServerPatternedProperty<number>("port", {
  ...
  page: "vpn-server.asp.html",
  type: "integer",
***REMOVED*** 1194, // Default for server 1
  validation: portValidator,
  ui: { label: "Port" },
});
...
export const vpn_server_remote = vpnServerPatternedProperty<string>("remote", {
  ...
  page: "vpn-server.asp.html",
  type: "ip",
***REMOVED*** "10.6.0.2", // Default for server 1
  ui: { label: "Local/remote endpoint addresses" },
});
...
export const vpn_server_sn = vpnServerPatternedProperty<string>("sn", {
  ...
  page: "vpn-server.asp.html",
  type: "ip",
***REMOVED*** "10.6.0.0", // Default for server 1
  ui: { label: "VPN subnet/netmask" },
});
...
export const wg_ip = wgProperty<string>("ip", {
  ...
  page: "vpn-wireguard.asp.html",
  type: "string",
***REMOVED*** "10.11.0.1/24", // Default is patterned
